  ...
  return (
    <div className="w-full sm:w-auto">
      <motion.div
        ...
        ref={ref}
      >
        <section className="rounded-lg relative bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:h-[22rem] group-even:pl-8 hover:bg-gray-200 transition flex flex-col sm:flex-row">
